...
| نقاط الدخول | 51 Edge Function (Deno) — الواجهة لا تلمس الجداول مباشرة |
...
- **مندوب**: شاشة «مهامي» تعرض البلاغات المُحالة إليه، يفتح التفاصيل ويضيف متابعات
  ويرفع **أدلة وصور** (كل شيء مسجَّل في سجل التدقيق).
- **فني**: بعد تسجيل صيانة/فرمتة تظهر «بطاقة تأكيد» تعرض اسم الفني والمحل والـ IMEI
  والتاريخ والوقت ورقم العملية، مع تنبيه أن السجل **غير قابل للحذف** (append-only).
