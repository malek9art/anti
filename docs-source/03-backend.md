...
1. فعّل قوالب الأعمال أولًا (انظر [`workflows/README.md`](workflows/README.md)).
2. أضف الأسرار الثلاثة (انظر [`01-setup.md`](01-setup.md)).
3. افتح تبويب **Actions** في المستودع.
4. اختر **«نشر الخلفية (لمرة واحدة)»** ← **Run workflow**.
5. انتظر اكتمال العمل (ينشر 44 دالة).
